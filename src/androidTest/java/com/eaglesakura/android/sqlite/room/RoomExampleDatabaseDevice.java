...
@Database(entities = {RoomExampleDatabaseDevice.ToDo.class, RoomExampleDatabaseDevice.User.class}, version = 1)
public abstract class RoomExampleDatabaseDevice extends RoomDatabase {
